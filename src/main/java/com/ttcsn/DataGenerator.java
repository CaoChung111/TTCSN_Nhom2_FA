...
public class DataGenerator {
    ...
    private static final int NUM_EDGES = 300;
    private static final String FILE_PATH = "src/main/resources/graph_data4.json";
