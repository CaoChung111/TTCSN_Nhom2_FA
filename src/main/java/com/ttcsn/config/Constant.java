...
public class Constant {
	...
	public static final String END_POINT = "Trạm 50";
	public static final double TIME_START = 7; // 7h

	// Giới hạn và hệ số phạt
	public static final double MAX_COST = 600000.00; // C_max
	...
	public static final double ALPHA = 0.3; // a - hệ số đột biến
	public static final int POPULATION_SIZE = 15; // n - số lượng đom đóm
	public static final int MAX_GENERATION = 50; // gen_max - số thế hệ tối đa
